...
namespace tinyxml2
{
    ...
    */
    ...
    void XMLDocument::SetError( XMLError error, int lineNum, const char * format, ... )
    {
        ...
        TIXML_SNPRINTF( buffer, BUFFER_SIZE, "Error=%s ErrorID=%d (0x%x) Line number=%d", ErrorIDToName( error ), static_cast<int>( error ), static_cast<unsigned int>( error ), lineNum );
